...
public interface VideoMapper extends BaseMapper<Video> {
    ...
    @Select("select id, url, cover_url, description, likes, comments, favorites, created_at from video where creator_id = #{userId} and status = 'UPLOADED' order by created_at desc")
