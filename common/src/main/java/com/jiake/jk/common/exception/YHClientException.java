package com.jiake.jk.common.exception;
...
public class YHClientException extends RuntimeException {
     ...
     * 只有枚举，没有动态详细信息的构造函数
     */
    public YHClientException(IErrorCode errorCode) {
     ...
     * @param args 动态参数
     */
    public YHClientException(IErrorCode errorCode, String logMessageFormat, Object... args) {
     ...
     * 包装第三方异常或系统异常
     */
    public YHClientException(IErrorCode errorCode, Throwable cause, String logMessageFormat, Object... args) {
